...
기본 모델은 `gemini-3.8-flash`(생각 수준 low, 2026년 말까지 할인 요금)이고, 안 되면 `gemini-3.5-flash`로 넘어갑니다. Flash-Lite는 더 싸지만 검색을 스스로 하지 않아 검색 확인이 안 되고, 생각 수준 medium은 비용이 몇 배로 늘어요.
